            ...
            <div className="max-w-4xl mx-auto prose prose-invert prose-lg">
              <div className="bg-card border border-border rounded-2xl p-8 md:p-12 space-y-8">
                ...
                <div>
                  ...
                  <h3 className="font-display text-xl font-semibold mb-2 text-foreground">2.3 Cookies e Tecnologias Similares</h3>
                  <p className="text-muted-foreground leading-relaxed">
                    Utilizamos cookies e tecnologias de rastreamento similares para melhorar sua experiência, 
                    analisar o uso do site e personalizar conteúdos.
                  </p>
                </div>

                <div>
                  <h2 className="font-display text-2xl font-bold mb-4 text-foreground">3. Como Usamos Suas Informações</h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <div>
                  <h2 className="font-display text-2xl font-bold mb-4 text-foreground">4. Compartilhamento de Informações</h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Não vendemos suas informações pessoais. Podemos compartilhar suas informações apenas nas seguintes situações:
                  </p>
                  <ul className="text-muted-foreground space-y-2 list-disc list-inside">
                    <li><strong>Prestadores de serviços:</strong> Empresas que nos auxiliam a operar o serviço (processamento de pagamentos, hospedagem, análise de dados)</li>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    criptografia de dados, firewalls, controles de acesso e monitoramento regular de nossos sistemas. 
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Mantemos suas informações pessoais pelo tempo necessário para fornecer os serviços solicitados 
                    e cumprir nossas obrigações legais. Após o encerramento de sua conta, podemos reter certas 
                    informações por um período limitado para fins de conformidade legal, resolução de disputas 
                    e cumprimento de nossos acordos.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    informações pessoais de crianças. Se você é pai ou responsável e acredita que seu filho 
                    nos forneceu informações pessoais, entre em contato conosco imediatamente.
                  </p>
                </div>

                <div>
                  <h2 className="font-display text-2xl font-bold mb-4 text-foreground">9. Links para Sites de Terceiros</h2>
                  <p className="text-muted-foreground leading-relaxed">
                    Nosso serviço pode conter links para sites de terceiros que não são operados por nós. 
                    Não temos controle sobre o conteúdo ou práticas de privacidade desses sites e não 
                    assumimos responsabilidade por eles. Recomendamos que você revise a política de 
                    privacidade de cada site que visitar.
                  </p>
                </div>

                <div>
                  <h2 className="font-display text-2xl font-bold mb-4 text-foreground">10. Transferências Internacionais</h2>
                  <p className="text-muted-foreground leading-relaxed">
                    Suas informações podem ser transferidas e armazenadas em servidores localizados fora 
                    do Brasil. Ao utilizar nosso serviço, você consente com essa transferência. Garantimos 
                    que todas as transferências internacionais sejam realizadas em conformidade com as 
                    leis de proteção de dados aplicáveis.
                  </p>
                </div>

                <div>
                  <h2 className="font-display text-2xl font-bold mb-4 text-foreground">11. Alterações nesta Política</h2>
                  <p className="text-muted-foreground leading-relaxed">
                    Podemos atualizar esta Política de Privacidade periodicamente. Notificaremos você sobre 
                    quaisquer alterações publicando a nova política nesta página e atualizando a data de 
                    última atualização. Recomendamos que você revise esta política regularmente.
                  </p>
                </div>
